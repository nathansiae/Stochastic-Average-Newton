...
"""
from solvers import SAN, SAG, SVRG, SANA, GradientDescent, Newton, SANid
...
n_repetition = 1  # number of repetitions run for stochastic algorithm

epochs = 30  # number of epochs to run for one algorithm, i.e., effective data passes
...
algorithms2run = "SAN, SAG, SVRG, SANA, GD, Newton, SANid"
# algorithms2run = "GD"
# string, all algorithm to test
